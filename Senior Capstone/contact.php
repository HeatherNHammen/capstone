<?php
//done following tutorial https://blog.mailtrap.io/react-contact-form/ by Alexandr Varnin
header("Access-Control-Allow-Origin: *");
header("Access-Control-Allow-Headers: Content-Type");
header("Content-Type: application/json");

//didn't explain this part, research and possibly change
